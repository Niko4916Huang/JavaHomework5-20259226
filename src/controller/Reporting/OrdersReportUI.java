...
public class OrdersReportUI extends JFrame {
	 ...
	 */
	public OrdersReportUI() throws ParseException {
		...
		JLabel lblNewLabel = new JLabel("銷 貨 報 表 作 業");
	...
	// 小時鐘介面
     ...
     // 啟動時鐘更新
		...
		JRadioButton select1 = new JRadioButton("依 客戶 編號 - 列印明細");
		...
		JRadioButton select3 = new JRadioButton("依 客戶 - 統計");
