...
public class EmployUI extends JFrame {
	...
	public EmployUI() {
		...
		JLabel lblNewLabel = new JLabel("員 工 - 基本資料作業");
...
//		comboBox List data	
			...
			List<Employee> listdata=new EmployeeServiceImpl().findAllEmployee();	
			for(Employee oneData:listdata)
			{
				String selectData = oneData.getEmployeeno() + "-" + oneData.getName();
				itemlist.add(selectData);
			}
